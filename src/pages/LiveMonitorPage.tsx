                                ...
                                {log.images.filter((img: any) => img.mediaType !== 'AUDIO').map((img: any) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className="group relative w-14 h-14 rounded-lg overflow-hidden bg-surface-900 border border-red-400/50 hover:scale-105 transition-all flex items-center justify-center"
                                    >
                                      {isVideo ? (
                                        <>
                                ...
                                {log.images.filter((img: any) => img.mediaType !== 'AUDIO').map((img: any) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      type="button"
                                      onClick={() => setPreviewMedia({ imageUrl: img.imageUrl, mediaType: img.mediaType || 'IMAGE' })}
                                      className="group relative w-14 h-14 rounded-lg overflow-hidden bg-surface-900 border border-amber-400/40 hover:scale-105 transition-all flex items-center justify-center"
                                    >
                                      {isVideo ? (
                                        <>
                                          <video src={img.imageUrl} className="w-full h-full object-cover opacity-75" />
                                      ...
                                      {log.images.filter((img: any) => img.mediaType !== 'AUDIO').map((img: any) => {
                                        ...
                                        return (
                                          <button
                                            ...
                                            type="button"
                                            onClick={() => setPreviewMedia({ imageUrl: img.imageUrl, mediaType: img.mediaType || 'IMAGE' })}
                                            className="group relative w-12 h-12 rounded-lg overflow-hidden bg-surface-900 border border-white/10 hover:border-brand-500 transition-colors flex items-center justify-center"
                                          >
                                            {isVideo ? (
                                              <>
                                                <video src={img.imageUrl} className="w-full h-full object-cover opacity-75" />
                                                <div className="absolute inset-0 flex items-center justify-center">
                                                  <div className="w-5 h-5 rounded-full bg-black/60 flex items-center justify-center text-white text-[9px]">▶</div>
                                                </div>
                                              </>
                                            ) : isFile ? (
                                              <div className="flex flex-col items-center justify-center text-center p-0.5">
                                                <span className="text-sm">📎</span>
                                                <span className="text-[6px] text-gray-400 truncate w-10">File</span>
                                              </div>
                                            ) : (
